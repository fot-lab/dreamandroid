// EulerAncestralDiscreteSampler implementation
...
class EulerAncestralDiscreteSampler : public Sampler {
 public:
  EulerAncestralDiscreteSampler(
  ...
  SamplerOutput step_with_noise(const xt::xarray<float> &model_output,
