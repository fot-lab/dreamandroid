// EulerDiscreteSampler implementation
...
class EulerDiscreteSampler : public Sampler {
 public:
  EulerDiscreteSampler(int num_train_timesteps, float beta_start,
